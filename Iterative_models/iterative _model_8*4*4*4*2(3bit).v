...
module layer (
  ...
  input wire  rst_n,
  input wire  start,
  input wire [2:0] inputs0_1, inputs1_1, inputs2_1, inputs3_1, inputs4_1, inputs5_1, inputs6_1, inputs7_1,
  input wire [2:0] act0_0_0, act0_0_1, act0_0_2, act0_0_3, act0_0_4, act0_0_5, act0_0_6, act0_0_7,
  input wire [2:0] act0_1_0, act0_1_1, act0_1_2, act0_1_3, act0_1_4, act0_1_5, act0_1_6, act0_1_7,
  input wire [2:0] act1_0_0, act1_0_1, act1_0_2, act1_0_3, act1_0_4, act1_0_5, act1_0_6, act1_0_7,
  input wire [2:0] act1_1_0, act1_1_1, act1_1_2, act1_1_3, act1_1_4, act1_1_5, act1_1_6, act1_1_7,
  input wire [2:0] act2_0_0, act2_0_1, act2_0_2, act2_0_3, act2_0_4, act2_0_5, act2_0_6, act2_0_7,
  input wire [2:0] act2_1_0, act2_1_1, act2_1_2, act2_1_3, act2_1_4, act2_1_5, act2_1_6, act2_1_7,
  input wire [2:0] act3_0_0, act3_0_1, act3_0_2, act3_0_3, act3_0_4, act3_0_5, act3_0_6, act3_0_7,
  input wire [2:0] act3_1_0, act3_1_1, act3_1_2, act3_1_3, act3_1_4, act3_1_5, act3_1_6, act3_1_7,
  input wire [7:0] w1_0_1, w1_1_1,
  input wire [7:0] w2_0_1, w2_1_1,
  input wire [7:0] w3_0_1, w3_1_1,
  input wire [7:0] w4_0_1, w4_1_1,
  input wire [5:0] b1_1, b1_2, b1_3, b1_4,
  input wire [5:0] b2_1, b2_2, b2_3, b2_4,
  input wire [5:0] b3_1, b3_2, b3_3, b3_4,
  input wire [5:0] b4_1, b4_2, b4_3, b4_4,
  input wire [1:0] s,
  output reg  done,
  output reg [6:0] biased_sum0_0_r, biased_sum0_1_r, biased_sum0_0bar_r, biased_sum0_1bar_r,
  output reg [6:0] biased_sum1_0_r, biased_sum1_1_r, biased_sum1_0bar_r, biased_sum1_1bar_r,
  output reg [6:0] biased_sum2_0_r, biased_sum2_1_r, biased_sum2_0bar_r, biased_sum2_1bar_r,
  output reg [6:0] biased_sum3_0_r, biased_sum3_1_r, biased_sum3_0bar_r, biased_sum3_1bar_r,
  ...
  wire [6:0] biased_sum2_0, biased_sum2_1, biased_sum2_0bar, biased_sum2_1bar;
  wire masked_activation2_1, masked_activation2bar_1;
  wire mask2_1, mask2bar_1;
  wire [6:0] biased_sum3_0, biased_sum3_1, biased_sum3_0bar, biased_sum3_1bar;
  ...
  wire [5:0] sum1 [3:0], sum2 [3:0], sum1bar [3:0], sum2bar [3 :0];
  wire [6:0] biased_sum1 [3:0], biased_sum2 [3:0], biased_sum1bar [3:0], biased_sum2bar [3:0];
  ...
  // bias addition
  add6bit     u0  (.a(sum1[0]),     .b(b1), .cin(1'b0), .y(biased_sum1[0]));
  add6bitbar ub0 (.a(sum1bar[0]), .b(b1), .cin(1'b0), .y(biased_sum1bar[0]));
  add6bit     u4  (.a(sum2[0]),     .b(b1), .cin(1'b0), .y(biased_sum2[0]));
  add6bitbar ub4 (.a(sum2bar[0]), .b(b1), .cin(1'b0), .y(biased_sum2bar[0]));
  add6bit     u1  (.a(sum1[1]),     .b(b2), .cin(1'b0), .y(biased_sum1[1]));
  add6bitbar ub1 (.a(sum1bar[1]), .b(b2), .cin(1'b0), .y(biased_sum1bar[1]));
  add6bit     u5  (.a(sum2[1]),     .b(b2), .cin(1'b0), .y(biased_sum2[1]));
  add6bitbar ub5 (.a(sum2bar[1]), .b(b2), .cin(1'b0), .y(biased_sum2bar[1]));
  add6bit     u2  (.a(sum1[2]),     .b(b3), .cin(1'b0), .y(biased_sum1[2]));
  add6bitbar ub2 (.a(sum1bar[2]), .b(b3), .cin(1'b0), .y(biased_sum1bar[2]));
  add6bit     u6  (.a(sum2[2]),     .b(b3), .cin(1'b0), .y(biased_sum2[2]));
  add6bitbar ub6 (.a(sum2bar[2]), .b(b3), .cin(1'b0), .y(biased_sum2bar[2]));
  add6bit     u3  (.a(sum1[3]),     .b(b4), .cin(1'b0), .y(biased_sum1[3]));
  add6bitbar ub3 (.a(sum1bar[3]), .b(b4), .cin(1'b0), .y(biased_sum1bar[3]));
  add6bit     u7  (.a(sum2[3]),     .b(b4), .cin(1'b0), .y(biased_sum2[3]));
  add6bitbar ub7 (.a(sum2bar[3]), .b(b4), .cin(1'b0), .y(biased_sum2bar[3]));
  ...
  always @(posedge clk or negedge rst_n) begin
    if (!rst_n) begin
      ...
      biased_sum0_0_r    <= 7'd0;  biased_sum0_1_r    <= 7'd0;
      biased_sum0_0bar_r <= 7'd0;  biased_sum0_1bar_r <= 7'd0;
      masked_activation0_1_r <= 1'b0; masked_activation0bar_1_r <= 1'b0;
      mask0_1_r             <= 1'b0;             mask0bar_1_r             <= 1'b0;
      biased_sum1_0_r    <= 7'd0;  biased_sum1_1_r    <= 7'd0;
      biased_sum1_0bar_r <= 7'd0;  biased_sum1_1bar_r <= 7'd0;
      masked_activation1_1_r <= 1'b0; masked_activation1bar_1_r <= 1'b0;
      mask1_1_r             <= 1'b0;             mask1bar_1_r             <= 1'b0;
      biased_sum2_0_r    <= 7'd0;  biased_sum2_1_r    <= 7'd0;
      biased_sum2_0bar_r <= 7'd0;  biased_sum2_1bar_r <= 7'd0;
      masked_activation2_1_r <= 1'b0; masked_activation2bar_1_r <= 1'b0;
      mask2_1_r             <= 1'b0;             mask2bar_1_r             <= 1'b0;
      biased_sum3_0_r    <= 7'd0;  biased_sum3_1_r    <= 7'd0;
      biased_sum3_0bar_r <= 7'd0;  biased_sum3_1bar_r <= 7'd0;
...
module share_boolean_arithmetic (
    ...
    output reg  [2:0]  act0_0_0_r, act0_0_1_r, act0_0_2_r, act0_0_3_r, act0_0_4_r, act0_0_5_r, act0_0_6_r, act0_0_7_r,
    output reg  [2:0]  act0_1_0_r, act0_1_1_r, act0_1_2_r, act0_1_3_r, act0_1_4_r, act0_1_5_r, act0_1_6_r, act0_1_7_r,
    output reg  [2:0]  act1_0_0_r, act1_0_1_r, act1_0_2_r, act1_0_3_r, act1_0_4_r, act1_0_5_r, act1_0_6_r, act1_0_7_r,
    output reg  [2:0]  act1_1_0_r, act1_1_1_r, act1_1_2_r, act1_1_3_r, act1_1_4_r, act1_1_5_r, act1_1_6_r, act1_1_7_r,
    output reg  [2:0]  act2_0_0_r, act2_0_1_r, act2_0_2_r, act2_0_3_r, act2_0_4_r, act2_0_5_r, act2_0_6_r, act2_0_7_r,
    output reg  [2:0]  act2_1_0_r, act2_1_1_r, act2_1_2_r, act2_1_3_r, act2_1_4_r, act2_1_5_r, act2_1_6_r, act2_1_7_r,
    output reg  [2:0]  act3_0_0_r, act3_0_1_r, act3_0_2_r, act3_0_3_r, act3_0_4_r, act3_0_5_r, act3_0_6_r, act3_0_7_r,
    output reg  [2:0]  act3_1_0_r, act3_1_1_r, act3_1_2_r, act3_1_3_r, act3_1_4_r, act3_1_5_r, act3_1_6_r, act3_1_7_r
);

  //--------------------------------------------------------------------------
  // 1) COMBINATIONAL WIRES
  //--------------------------------------------------------------------------
  reg [1:0] ar0, ar1, ar2, ar3;
...
module output_layer (
  ...
  input  wire [6:0] biased_sum0_1bar,
  input  wire [6:0] biased_sum1_0,
  input  wire [6:0] biased_sum1_1,
  input  wire [6:0] biased_sum1_0bar,
  input  wire [6:0] biased_sum1_1bar,
