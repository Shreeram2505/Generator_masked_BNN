...
module layer2(
    input [2:0] inputs0_2 , inputs1_2 , inputs2_2 , inputs3_2 , inputs4_2 , inputs5_2 , inputs6_2 , inputs7_2 , inputs8_2 , inputs9_2 , inputs10_2 , inputs11_2 , inputs12_2 , inputs13_2 , inputs14_2 , inputs15_2,
    input [15:0] w1_0_2, w1_1_2, w2_0_2, w2_1_2, w3_0_2, w3_1_2, w4_0_2, w4_1_2,
    ...
    weighted_inputs_1 w16 (.inputs(inputs0_2), .w(w2_0_2[0]), .wi(weighted_inputs2_0_0));
    weighted_inputs_1 w16_bar (.inputs(inputs0_2), .w(w2_1_2[0]), .wi(weighted_inputs2_0_1));
    weighted_inputs_1 w17 (.inputs(inputs1_2), .w(w2_0_2[1]), .wi(weighted_inputs2_1_0));
    weighted_inputs_1 w17_bar (.inputs(inputs1_2), .w(w2_1_2[1]), .wi(weighted_inputs2_1_1));
    weighted_inputs_1 w18 (.inputs(inputs2_2), .w(w2_0_2[2]), .wi(weighted_inputs2_2_0));
    weighted_inputs_1 w18_bar (.inputs(inputs2_2), .w(w2_1_2[2]), .wi(weighted_inputs2_2_1));
    weighted_inputs_1 w19 (.inputs(inputs3_2), .w(w2_0_2[3]), .wi(weighted_inputs2_3_0));
    weighted_inputs_1 w19_bar (.inputs(inputs3_2), .w(w2_1_2[3]), .wi(weighted_inputs2_3_1));
    weighted_inputs_1 w20 (.inputs(inputs4_2), .w(w2_0_2[4]), .wi(weighted_inputs2_4_0));
    weighted_inputs_1 w20_bar (.inputs(inputs4_2), .w(w2_1_2[4]), .wi(weighted_inputs2_4_1));
    weighted_inputs_1 w21 (.inputs(inputs5_2), .w(w2_0_2[5]), .wi(weighted_inputs2_5_0));
    weighted_inputs_1 w21_bar (.inputs(inputs5_2), .w(w2_1_2[5]), .wi(weighted_inputs2_5_1));
    weighted_inputs_1 w22 (.inputs(inputs6_2), .w(w2_0_2[6]), .wi(weighted_inputs2_6_0));
    weighted_inputs_1 w22_bar (.inputs(inputs6_2), .w(w2_1_2[6]), .wi(weighted_inputs2_6_1));
    weighted_inputs_1 w23 (.inputs(inputs7_2), .w(w2_0_2[7]), .wi(weighted_inputs2_7_0));
    weighted_inputs_1 w23_bar (.inputs(inputs7_2), .w(w2_1_2[7]), .wi(weighted_inputs2_7_1));
    weighted_inputs_1 w24 (.inputs(inputs8_2), .w(w2_0_2[8]), .wi(weighted_inputs2_8_0));
    weighted_inputs_1 w24_bar (.inputs(inputs8_2), .w(w2_1_2[8]), .wi(weighted_inputs2_8_1));
    weighted_inputs_1 w25 (.inputs(inputs9_2), .w(w2_0_2[9]), .wi(weighted_inputs2_9_0));
    weighted_inputs_1 w25_bar (.inputs(inputs9_2), .w(w2_1_2[9]), .wi(weighted_inputs2_9_1));
    weighted_inputs_1 w26 (.inputs(inputs10_2), .w(w2_0_2[10]), .wi(weighted_inputs2_10_0));
    weighted_inputs_1 w26_bar (.inputs(inputs10_2), .w(w2_1_2[10]), .wi(weighted_inputs2_10_1));
    weighted_inputs_1 w27 (.inputs(inputs11_2), .w(w2_0_2[11]), .wi(weighted_inputs2_11_0));
    weighted_inputs_1 w27_bar (.inputs(inputs11_2), .w(w2_1_2[11]), .wi(weighted_inputs2_11_1));
    weighted_inputs_1 w28 (.inputs(inputs12_2), .w(w2_0_2[12]), .wi(weighted_inputs2_12_0));
    weighted_inputs_1 w28_bar (.inputs(inputs12_2), .w(w2_1_2[12]), .wi(weighted_inputs2_12_1));
    weighted_inputs_1 w29 (.inputs(inputs13_2), .w(w2_0_2[13]), .wi(weighted_inputs2_13_0));
    weighted_inputs_1 w29_bar (.inputs(inputs13_2), .w(w2_1_2[13]), .wi(weighted_inputs2_13_1));
    weighted_inputs_1 w30 (.inputs(inputs14_2), .w(w2_0_2[14]), .wi(weighted_inputs2_14_0));
    weighted_inputs_1 w30_bar (.inputs(inputs14_2), .w(w2_1_2[14]), .wi(weighted_inputs2_14_1));
    weighted_inputs_1 w31 (.inputs(inputs15_2), .w(w2_0_2[15]), .wi(weighted_inputs2_15_0));
    weighted_inputs_1 w31_bar (.inputs(inputs15_2), .w(w2_1_2[15]), .wi(weighted_inputs2_15_1));
    weighted_inputs_1 w32 (.inputs(inputs0_2), .w(w3_0_2[0]), .wi(weighted_inputs3_0_0));
    weighted_inputs_1 w32_bar (.inputs(inputs0_2), .w(w3_1_2[0]), .wi(weighted_inputs3_0_1));
    weighted_inputs_1 w33 (.inputs(inputs1_2), .w(w3_0_2[1]), .wi(weighted_inputs3_1_0));
    weighted_inputs_1 w33_bar (.inputs(inputs1_2), .w(w3_1_2[1]), .wi(weighted_inputs3_1_1));
    weighted_inputs_1 w34 (.inputs(inputs2_2), .w(w3_0_2[2]), .wi(weighted_inputs3_2_0));
    weighted_inputs_1 w34_bar (.inputs(inputs2_2), .w(w3_1_2[2]), .wi(weighted_inputs3_2_1));
    weighted_inputs_1 w35 (.inputs(inputs3_2), .w(w3_0_2[3]), .wi(weighted_inputs3_3_0));
    weighted_inputs_1 w35_bar (.inputs(inputs3_2), .w(w3_1_2[3]), .wi(weighted_inputs3_3_1));
    weighted_inputs_1 w36 (.inputs(inputs4_2), .w(w3_0_2[4]), .wi(weighted_inputs3_4_0));
    weighted_inputs_1 w36_bar (.inputs(inputs4_2), .w(w3_1_2[4]), .wi(weighted_inputs3_4_1));
    weighted_inputs_1 w37 (.inputs(inputs5_2), .w(w3_0_2[5]), .wi(weighted_inputs3_5_0));
    weighted_inputs_1 w37_bar (.inputs(inputs5_2), .w(w3_1_2[5]), .wi(weighted_inputs3_5_1));
    weighted_inputs_1 w38 (.inputs(inputs6_2), .w(w3_0_2[6]), .wi(weighted_inputs3_6_0));
    weighted_inputs_1 w38_bar (.inputs(inputs6_2), .w(w3_1_2[6]), .wi(weighted_inputs3_6_1));
    weighted_inputs_1 w39 (.inputs(inputs7_2), .w(w3_0_2[7]), .wi(weighted_inputs3_7_0));
    weighted_inputs_1 w39_bar (.inputs(inputs7_2), .w(w3_1_2[7]), .wi(weighted_inputs3_7_1));
    weighted_inputs_1 w40 (.inputs(inputs8_2), .w(w3_0_2[8]), .wi(weighted_inputs3_8_0));
    weighted_inputs_1 w40_bar (.inputs(inputs8_2), .w(w3_1_2[8]), .wi(weighted_inputs3_8_1));
    weighted_inputs_1 w41 (.inputs(inputs9_2), .w(w3_0_2[9]), .wi(weighted_inputs3_9_0));
    weighted_inputs_1 w41_bar (.inputs(inputs9_2), .w(w3_1_2[9]), .wi(weighted_inputs3_9_1));
    weighted_inputs_1 w42 (.inputs(inputs10_2), .w(w3_0_2[10]), .wi(weighted_inputs3_10_0));
    weighted_inputs_1 w42_bar (.inputs(inputs10_2), .w(w3_1_2[10]), .wi(weighted_inputs3_10_1));
    weighted_inputs_1 w43 (.inputs(inputs11_2), .w(w3_0_2[11]), .wi(weighted_inputs3_11_0));
    weighted_inputs_1 w43_bar (.inputs(inputs11_2), .w(w3_1_2[11]), .wi(weighted_inputs3_11_1));
    weighted_inputs_1 w44 (.inputs(inputs12_2), .w(w3_0_2[12]), .wi(weighted_inputs3_12_0));
    weighted_inputs_1 w44_bar (.inputs(inputs12_2), .w(w3_1_2[12]), .wi(weighted_inputs3_12_1));
    weighted_inputs_1 w45 (.inputs(inputs13_2), .w(w3_0_2[13]), .wi(weighted_inputs3_13_0));
    weighted_inputs_1 w45_bar (.inputs(inputs13_2), .w(w3_1_2[13]), .wi(weighted_inputs3_13_1));
    weighted_inputs_1 w46 (.inputs(inputs14_2), .w(w3_0_2[14]), .wi(weighted_inputs3_14_0));
    weighted_inputs_1 w46_bar (.inputs(inputs14_2), .w(w3_1_2[14]), .wi(weighted_inputs3_14_1));
    weighted_inputs_1 w47 (.inputs(inputs15_2), .w(w3_0_2[15]), .wi(weighted_inputs3_15_0));
    weighted_inputs_1 w47_bar (.inputs(inputs15_2), .w(w3_1_2[15]), .wi(weighted_inputs3_15_1));
    weighted_inputs_1 w48 (.inputs(inputs0_2), .w(w4_0_2[0]), .wi(weighted_inputs4_0_0));
    weighted_inputs_1 w48_bar (.inputs(inputs0_2), .w(w4_1_2[0]), .wi(weighted_inputs4_0_1));
    weighted_inputs_1 w49 (.inputs(inputs1_2), .w(w4_0_2[1]), .wi(weighted_inputs4_1_0));
    weighted_inputs_1 w49_bar (.inputs(inputs1_2), .w(w4_1_2[1]), .wi(weighted_inputs4_1_1));
    weighted_inputs_1 w50 (.inputs(inputs2_2), .w(w4_0_2[2]), .wi(weighted_inputs4_2_0));
    weighted_inputs_1 w50_bar (.inputs(inputs2_2), .w(w4_1_2[2]), .wi(weighted_inputs4_2_1));
    weighted_inputs_1 w51 (.inputs(inputs3_2), .w(w4_0_2[3]), .wi(weighted_inputs4_3_0));
    weighted_inputs_1 w51_bar (.inputs(inputs3_2), .w(w4_1_2[3]), .wi(weighted_inputs4_3_1));
    weighted_inputs_1 w52 (.inputs(inputs4_2), .w(w4_0_2[4]), .wi(weighted_inputs4_4_0));
    weighted_inputs_1 w52_bar (.inputs(inputs4_2), .w(w4_1_2[4]), .wi(weighted_inputs4_4_1));
    weighted_inputs_1 w53 (.inputs(inputs5_2), .w(w4_0_2[5]), .wi(weighted_inputs4_5_0));
    weighted_inputs_1 w53_bar (.inputs(inputs5_2), .w(w4_1_2[5]), .wi(weighted_inputs4_5_1));
    weighted_inputs_1 w54 (.inputs(inputs6_2), .w(w4_0_2[6]), .wi(weighted_inputs4_6_0));
    weighted_inputs_1 w54_bar (.inputs(inputs6_2), .w(w4_1_2[6]), .wi(weighted_inputs4_6_1));
    weighted_inputs_1 w55 (.inputs(inputs7_2), .w(w4_0_2[7]), .wi(weighted_inputs4_7_0));
    weighted_inputs_1 w55_bar (.inputs(inputs7_2), .w(w4_1_2[7]), .wi(weighted_inputs4_7_1));
    weighted_inputs_1 w56 (.inputs(inputs8_2), .w(w4_0_2[8]), .wi(weighted_inputs4_8_0));
    weighted_inputs_1 w56_bar (.inputs(inputs8_2), .w(w4_1_2[8]), .wi(weighted_inputs4_8_1));
    weighted_inputs_1 w57 (.inputs(inputs9_2), .w(w4_0_2[9]), .wi(weighted_inputs4_9_0));
    weighted_inputs_1 w57_bar (.inputs(inputs9_2), .w(w4_1_2[9]), .wi(weighted_inputs4_9_1));
    weighted_inputs_1 w58 (.inputs(inputs10_2), .w(w4_0_2[10]), .wi(weighted_inputs4_10_0));
    weighted_inputs_1 w58_bar (.inputs(inputs10_2), .w(w4_1_2[10]), .wi(weighted_inputs4_10_1));
    weighted_inputs_1 w59 (.inputs(inputs11_2), .w(w4_0_2[11]), .wi(weighted_inputs4_11_0));
    weighted_inputs_1 w59_bar (.inputs(inputs11_2), .w(w4_1_2[11]), .wi(weighted_inputs4_11_1));
    weighted_inputs_1 w60 (.inputs(inputs12_2), .w(w4_0_2[12]), .wi(weighted_inputs4_12_0));
    weighted_inputs_1 w60_bar (.inputs(inputs12_2), .w(w4_1_2[12]), .wi(weighted_inputs4_12_1));
    weighted_inputs_1 w61 (.inputs(inputs13_2), .w(w4_0_2[13]), .wi(weighted_inputs4_13_0));
    weighted_inputs_1 w61_bar (.inputs(inputs13_2), .w(w4_1_2[13]), .wi(weighted_inputs4_13_1));
    weighted_inputs_1 w62 (.inputs(inputs14_2), .w(w4_0_2[14]), .wi(weighted_inputs4_14_0));
    weighted_inputs_1 w62_bar (.inputs(inputs14_2), .w(w4_1_2[14]), .wi(weighted_inputs4_14_1));
    weighted_inputs_1 w63 (.inputs(inputs15_2), .w(w4_0_2[15]), .wi(weighted_inputs4_15_0));
    weighted_inputs_1 w63_bar (.inputs(inputs15_2), .w(w4_1_2[15]), .wi(weighted_inputs4_15_1));
    adder_tree_2 add0(
        .in0(weighted_inputs1_0_0),
        .in1(weighted_inputs1_1_0),
        .in2(weighted_inputs1_2_0),
    ...
    add7bit_2 u0 (.a(sum1[0]), .b(b1_2), .cin(1'b0), .y(biased_sum1[0]));
    add7bit_2 u4 (.a(sum2[0]), .b(b1_2), .cin(1'b0), .y(biased_sum2[0]));
    add7bitbar_2 ub0 (.a(sum1bar[0]), .b(b1_2), .cin(1'b0), .y(biased_sum1bar[0]));
    add7bitbar_2 ub4 (.a(sum2bar[0]), .b(b1_2), .cin(1'b0), .y(biased_sum2bar[0]));
    add7bit_2 u1 (.a(sum1[1]), .b(b2_2), .cin(1'b0), .y(biased_sum1[1]));
    add7bit_2 u5 (.a(sum2[1]), .b(b2_2), .cin(1'b0), .y(biased_sum2[1]));
    add7bitbar_2 ub1 (.a(sum1bar[1]), .b(b2_2), .cin(1'b0), .y(biased_sum1bar[1]));
    add7bitbar_2 ub5 (.a(sum2bar[1]), .b(b2_2), .cin(1'b0), .y(biased_sum2bar[1]));
    add7bit_2 u2 (.a(sum1[2]), .b(b3_2), .cin(1'b0), .y(biased_sum1[2]));
    add7bit_2 u6 (.a(sum2[2]), .b(b3_2), .cin(1'b0), .y(biased_sum2[2]));
    add7bitbar_2 ub2 (.a(sum1bar[2]), .b(b3_2), .cin(1'b0), .y(biased_sum1bar[2]));
    add7bitbar_2 ub6 (.a(sum2bar[2]), .b(b3_2), .cin(1'b0), .y(biased_sum2bar[2]));
    add7bit_2 u3 (.a(sum1[3]), .b(b4_2), .cin(1'b0), .y(biased_sum1[3]));
    add7bit_2 u7 (.a(sum2[3]), .b(b4_2), .cin(1'b0), .y(biased_sum2[3]));
    add7bitbar_2 ub3 (.a(sum1bar[3]), .b(b4_2), .cin(1'b0), .y(biased_sum1bar[3]));
    add7bitbar_2 ub7 (.a(sum2bar[3]), .b(b4_2), .cin(1'b0), .y(biased_sum2bar[3]));
    assign biased_sum0_0 = biased_sum1[0];
    assign biased_sum0_1 = biased_sum2[0];
    assign biased_sum0_0bar = biased_sum1bar[0];
    assign biased_sum0_1bar = biased_sum2bar[0];
...
module activation_and_conversion_2(
  ...
  input  wire [6:0] b1_2, b2_2, b3_2, b4_2,
  input  wire r0_0,
  input  wire r1_0,
  input  wire r2_0,
  input  wire r3_0,
...
module layer3(
    ...
    input [7:0] w1_0_3, w1_1_3, w2_0_3, w2_1_3,
    input [5:0] b1_3, b2_3,
    ...
    add6bit_3 u2 (.a(sum2[0]), .b(b1_3), .cin(1'b0), .y(biased_sum2[0]));
    add6bitbar_3 ub0 (.a(sum1bar[0]), .b(b1_3), .cin(1'b0), .y(biased_sum1bar[0]));
    add6bitbar_3 ub2 (.a(sum2bar[0]), .b(b1_3), .cin(1'b0), .y(biased_sum2bar[0]));
    add6bit_3 u1 (.a(sum1[1]), .b(b2_3), .cin(1'b0), .y(biased_sum1[1]));
    add6bit_3 u3 (.a(sum2[1]), .b(b2_3), .cin(1'b0), .y(biased_sum2[1]));
    add6bitbar_3 ub1 (.a(sum1bar[1]), .b(b2_3), .cin(1'b0), .y(biased_sum1bar[1]));
    add6bitbar_3 ub3 (.a(sum2bar[1]), .b(b2_3), .cin(1'b0), .y(biased_sum2bar[1]));
    assign biased_sum0_0 = biased_sum1[0];
    assign biased_sum0_1 = biased_sum2[0];
    assign biased_sum0_0bar = biased_sum1bar[0];
    assign biased_sum0_1bar = biased_sum2bar[0];
...
module connector(
  ...
  reg [1:0] ar0_1, ar1_1, ar2_1, ar3_1, ar4_1, ar5_1, ar6_1, ar7_1;
  reg [1:0] ar0bar_1, ar1bar_1, ar2bar_1, ar3bar_1, ar4bar_1, ar5bar_1, ar6bar_1, ar7bar_1;
 ...
 wire [2:0] act7_0bar_1, act7_1bar_1;
  activation_and_conversion_1 layer1_inst (
    ...
    .mask7_1(mask7_1), .mask7bar_1(mask7bar_1),
      .ar0(ar0_1), .ar0bar(ar0bar_1),   .ar1(ar1_1), .ar1bar(ar1bar_1),   .ar2(ar2_1), .ar2bar(ar2bar_1),   .ar3(ar3_1), .ar3bar(ar3bar_1),   .ar4(ar4_1), .ar4bar(ar4bar_1),   .ar5(ar5_1), .ar5bar(ar5bar_1),   .ar6(ar6_1), .ar6bar(ar6bar_1),   .ar7(ar7_1), .ar7bar(ar7bar_1),
