...
module layer1(
    ...
    output [11:0] biased_sum0_0, biased_sum0_1, biased_sum0_0bar, biased_sum0_1bar, biased_sum1_0, biased_sum1_1, biased_sum1_0bar, biased_sum1_1bar, biased_sum2_0, biased_sum2_1, biased_sum2_0bar, biased_sum2_1bar, biased_sum3_0, biased_sum3_1, biased_sum3_0bar, biased_sum3_1bar
);
    ...
    wire [11:0] biased_sum2 [3:0];
    wire [10:0] sum1bar [3:0];
    wire [10:0] sum2bar [3:0];
    wire [11:0] biased_sum1bar [3:0];
    wire [11:0] biased_sum2bar [3:0];
    ...
    add11bit_1 u4 (.a(sum2[0]), .b(b1_1), .cin(1'b0), .y(biased_sum2[0]));
    add11bitbar_1 ub0 (.a(sum1bar[0]), .b(b1_1), .cin(1'b0), .y(biased_sum1bar[0]));
    add11bitbar_1 ub4 (.a(sum2bar[0]), .b(b1_1), .cin(1'b0), .y(biased_sum2bar[0]));
    add11bit_1 u1 (.a(sum1[1]), .b(b2_1), .cin(1'b0), .y(biased_sum1[1]));
    add11bit_1 u5 (.a(sum2[1]), .b(b2_1), .cin(1'b0), .y(biased_sum2[1]));
    add11bitbar_1 ub1 (.a(sum1bar[1]), .b(b2_1), .cin(1'b0), .y(biased_sum1bar[1]));
    add11bitbar_1 ub5 (.a(sum2bar[1]), .b(b2_1), .cin(1'b0), .y(biased_sum2bar[1]));
    add11bit_1 u2 (.a(sum1[2]), .b(b3_1), .cin(1'b0), .y(biased_sum1[2]));
    add11bit_1 u6 (.a(sum2[2]), .b(b3_1), .cin(1'b0), .y(biased_sum2[2]));
    add11bitbar_1 ub2 (.a(sum1bar[2]), .b(b3_1), .cin(1'b0), .y(biased_sum1bar[2]));
    add11bitbar_1 ub6 (.a(sum2bar[2]), .b(b3_1), .cin(1'b0), .y(biased_sum2bar[2]));
    add11bit_1 u3 (.a(sum1[3]), .b(b4_1), .cin(1'b0), .y(biased_sum1[3]));
    add11bit_1 u7 (.a(sum2[3]), .b(b4_1), .cin(1'b0), .y(biased_sum2[3]));
    add11bitbar_1 ub3 (.a(sum1bar[3]), .b(b4_1), .cin(1'b0), .y(biased_sum1bar[3]));
    add11bitbar_1 ub7 (.a(sum2bar[3]), .b(b4_1), .cin(1'b0), .y(biased_sum2bar[3]));
...
module activation_and_conversion_1(
  ...
  wire [11:0] biased_sum0_0, biased_sum0_0bar;
  wire [11:0] biased_sum0_1, biased_sum0_1bar;
  wire [11:0] biased_sum1_0, biased_sum1_0bar;
  wire [11:0] biased_sum1_1, biased_sum1_1bar;
  wire [11:0] biased_sum2_0, biased_sum2_0bar;
  wire [11:0] biased_sum2_1, biased_sum2_1bar;
  wire [11:0] biased_sum3_0, biased_sum3_0bar;
...
module layer2(
    ...
    output [4:0] biased_sum0_0, biased_sum0_1, biased_sum0_0bar, biased_sum0_1bar, biased_sum1_0, biased_sum1_1, biased_sum1_0bar, biased_sum1_1bar, biased_sum2_0, biased_sum2_1, biased_sum2_0bar, biased_sum2_1bar, biased_sum3_0, biased_sum3_1, biased_sum3_0bar, biased_sum3_1bar
);
    ...
    wire [4:0] biased_sum2 [3:0];
    wire [3:0] sum1bar [3:0];
    wire [3:0] sum2bar [3:0];
    wire [4:0] biased_sum1bar [3:0];
    wire [4:0] biased_sum2bar [3:0];
    ...
    weighted_inputs_2 w8 (.inputs(inputs0_2), .w(w2_0_2[0]), .wi(weighted_inputs2_0_0));
    weighted_inputs_2 w8_bar (.inputs(inputs0_2), .w(w2_1_2[0]), .wi(weighted_inputs2_0_1));
    weighted_inputs_2 w9 (.inputs(inputs1_2), .w(w2_0_2[1]), .wi(weighted_inputs2_1_0));
    weighted_inputs_2 w9_bar (.inputs(inputs1_2), .w(w2_1_2[1]), .wi(weighted_inputs2_1_1));
    weighted_inputs_2 w10 (.inputs(inputs2_2), .w(w2_0_2[2]), .wi(weighted_inputs2_2_0));
    weighted_inputs_2 w10_bar (.inputs(inputs2_2), .w(w2_1_2[2]), .wi(weighted_inputs2_2_1));
    weighted_inputs_2 w11 (.inputs(inputs3_2), .w(w2_0_2[3]), .wi(weighted_inputs2_3_0));
    weighted_inputs_2 w11_bar (.inputs(inputs3_2), .w(w2_1_2[3]), .wi(weighted_inputs2_3_1));
    weighted_inputs_2 w12 (.inputs(inputs4_2), .w(w2_0_2[4]), .wi(weighted_inputs2_4_0));
    weighted_inputs_2 w12_bar (.inputs(inputs4_2), .w(w2_1_2[4]), .wi(weighted_inputs2_4_1));
    weighted_inputs_2 w13 (.inputs(inputs5_2), .w(w2_0_2[5]), .wi(weighted_inputs2_5_0));
    weighted_inputs_2 w13_bar (.inputs(inputs5_2), .w(w2_1_2[5]), .wi(weighted_inputs2_5_1));
    weighted_inputs_2 w14 (.inputs(inputs6_2), .w(w2_0_2[6]), .wi(weighted_inputs2_6_0));
    weighted_inputs_2 w14_bar (.inputs(inputs6_2), .w(w2_1_2[6]), .wi(weighted_inputs2_6_1));
    weighted_inputs_2 w15 (.inputs(inputs7_2), .w(w2_0_2[7]), .wi(weighted_inputs2_7_0));
    weighted_inputs_2 w15_bar (.inputs(inputs7_2), .w(w2_1_2[7]), .wi(weighted_inputs2_7_1));
    weighted_inputs_2 w16 (.inputs(inputs0_2), .w(w3_0_2[0]), .wi(weighted_inputs3_0_0));
    weighted_inputs_2 w16_bar (.inputs(inputs0_2), .w(w3_1_2[0]), .wi(weighted_inputs3_0_1));
    weighted_inputs_2 w17 (.inputs(inputs1_2), .w(w3_0_2[1]), .wi(weighted_inputs3_1_0));
    weighted_inputs_2 w17_bar (.inputs(inputs1_2), .w(w3_1_2[1]), .wi(weighted_inputs3_1_1));
    weighted_inputs_2 w18 (.inputs(inputs2_2), .w(w3_0_2[2]), .wi(weighted_inputs3_2_0));
    weighted_inputs_2 w18_bar (.inputs(inputs2_2), .w(w3_1_2[2]), .wi(weighted_inputs3_2_1));
    weighted_inputs_2 w19 (.inputs(inputs3_2), .w(w3_0_2[3]), .wi(weighted_inputs3_3_0));
    weighted_inputs_2 w19_bar (.inputs(inputs3_2), .w(w3_1_2[3]), .wi(weighted_inputs3_3_1));
    weighted_inputs_2 w20 (.inputs(inputs4_2), .w(w3_0_2[4]), .wi(weighted_inputs3_4_0));
    weighted_inputs_2 w20_bar (.inputs(inputs4_2), .w(w3_1_2[4]), .wi(weighted_inputs3_4_1));
    weighted_inputs_2 w21 (.inputs(inputs5_2), .w(w3_0_2[5]), .wi(weighted_inputs3_5_0));
    weighted_inputs_2 w21_bar (.inputs(inputs5_2), .w(w3_1_2[5]), .wi(weighted_inputs3_5_1));
    weighted_inputs_2 w22 (.inputs(inputs6_2), .w(w3_0_2[6]), .wi(weighted_inputs3_6_0));
    weighted_inputs_2 w22_bar (.inputs(inputs6_2), .w(w3_1_2[6]), .wi(weighted_inputs3_6_1));
    weighted_inputs_2 w23 (.inputs(inputs7_2), .w(w3_0_2[7]), .wi(weighted_inputs3_7_0));
    weighted_inputs_2 w23_bar (.inputs(inputs7_2), .w(w3_1_2[7]), .wi(weighted_inputs3_7_1));
    weighted_inputs_2 w24 (.inputs(inputs0_2), .w(w4_0_2[0]), .wi(weighted_inputs4_0_0));
    weighted_inputs_2 w24_bar (.inputs(inputs0_2), .w(w4_1_2[0]), .wi(weighted_inputs4_0_1));
    weighted_inputs_2 w25 (.inputs(inputs1_2), .w(w4_0_2[1]), .wi(weighted_inputs4_1_0));
    weighted_inputs_2 w25_bar (.inputs(inputs1_2), .w(w4_1_2[1]), .wi(weighted_inputs4_1_1));
    weighted_inputs_2 w26 (.inputs(inputs2_2), .w(w4_0_2[2]), .wi(weighted_inputs4_2_0));
    weighted_inputs_2 w26_bar (.inputs(inputs2_2), .w(w4_1_2[2]), .wi(weighted_inputs4_2_1));
    weighted_inputs_2 w27 (.inputs(inputs3_2), .w(w4_0_2[3]), .wi(weighted_inputs4_3_0));
    weighted_inputs_2 w27_bar (.inputs(inputs3_2), .w(w4_1_2[3]), .wi(weighted_inputs4_3_1));
    weighted_inputs_2 w28 (.inputs(inputs4_2), .w(w4_0_2[4]), .wi(weighted_inputs4_4_0));
    weighted_inputs_2 w28_bar (.inputs(inputs4_2), .w(w4_1_2[4]), .wi(weighted_inputs4_4_1));
    weighted_inputs_2 w29 (.inputs(inputs5_2), .w(w4_0_2[5]), .wi(weighted_inputs4_5_0));
    weighted_inputs_2 w29_bar (.inputs(inputs5_2), .w(w4_1_2[5]), .wi(weighted_inputs4_5_1));
    weighted_inputs_2 w30 (.inputs(inputs6_2), .w(w4_0_2[6]), .wi(weighted_inputs4_6_0));
    weighted_inputs_2 w30_bar (.inputs(inputs6_2), .w(w4_1_2[6]), .wi(weighted_inputs4_6_1));
    ...
    add4bit_2 u4 (.a(sum2[0]), .b(b1_2), .cin(1'b0), .y(biased_sum2[0]));
    add4bitbar_2 ub0 (.a(sum1bar[0]), .b(b1_2), .cin(1'b0), .y(biased_sum1bar[0]));
    add4bitbar_2 ub4 (.a(sum2bar[0]), .b(b1_2), .cin(1'b0), .y(biased_sum2bar[0]));
    add4bit_2 u1 (.a(sum1[1]), .b(b2_2), .cin(1'b0), .y(biased_sum1[1]));
    add4bit_2 u5 (.a(sum2[1]), .b(b2_2), .cin(1'b0), .y(biased_sum2[1]));
    add4bitbar_2 ub1 (.a(sum1bar[1]), .b(b2_2), .cin(1'b0), .y(biased_sum1bar[1]));
    add4bitbar_2 ub5 (.a(sum2bar[1]), .b(b2_2), .cin(1'b0), .y(biased_sum2bar[1]));
    add4bit_2 u2 (.a(sum1[2]), .b(b3_2), .cin(1'b0), .y(biased_sum1[2]));
    add4bit_2 u6 (.a(sum2[2]), .b(b3_2), .cin(1'b0), .y(biased_sum2[2]));
    add4bitbar_2 ub2 (.a(sum1bar[2]), .b(b3_2), .cin(1'b0), .y(biased_sum1bar[2]));
    add4bitbar_2 ub6 (.a(sum2bar[2]), .b(b3_2), .cin(1'b0), .y(biased_sum2bar[2]));
    add4bit_2 u3 (.a(sum1[3]), .b(b4_2), .cin(1'b0), .y(biased_sum1[3]));
    add4bit_2 u7 (.a(sum2[3]), .b(b4_2), .cin(1'b0), .y(biased_sum2[3]));
    add4bitbar_2 ub3 (.a(sum1bar[3]), .b(b4_2), .cin(1'b0), .y(biased_sum1bar[3]));
    add4bitbar_2 ub7 (.a(sum2bar[3]), .b(b4_2), .cin(1'b0), .y(biased_sum2bar[3]));
    assign biased_sum0_0 = biased_sum1[0];
    assign biased_sum0_1 = biased_sum2[0];
    assign biased_sum0_0bar = biased_sum1bar[0];
    assign biased_sum0_1bar = biased_sum2bar[0];
...
module activation_2 (
    ...
    input r0_0, r1_0, r2_0, r3_0, r4_0,
    ...
    wire activation = (carry ^ inputs0_0[4] ^ inputs0_1[4]) ? 1'b0 : 1'b1;

    assign masked_activation = activation ^ r5;
    assign mask = r5;

endmodule

module activation_array_2 (
    input  [4:0] inputs0_0, inputs0_1,
    input  [4:0] inputs1_0, inputs1_1,
    input  [4:0] inputs2_0, inputs2_1,
    input  [4:0] inputs3_0, inputs3_1,
    input  r0_0, r1_0, r2_0, r3_0, r4_0,
    input  r0_1, r1_1, r2_1, r3_1, r4_1,
    input  r0_2, r1_2, r2_2, r3_2, r4_2,
    input  r0_3, r1_3, r2_3, r3_3, r4_3,
    output wire masked_activation0,
    output wire masked_activation1,
    output wire masked_activation2,
    output wire masked_activation3,
...
module activation_and_conversion_2(
  ...
  input  wire [3:0] b1_2, b2_2, b3_2, b4_2,
  input  wire r0_0,
  input  wire r1_0,
  input  wire r2_0,
  input  wire r3_0,
  ...
  wire [4:0] biased_sum0_0, biased_sum0_0bar;
  wire [4:0] biased_sum0_1, biased_sum0_1bar;
  wire [4:0] biased_sum1_0, biased_sum1_0bar;
  wire [4:0] biased_sum1_1, biased_sum1_1bar;
  wire [4:0] biased_sum2_0, biased_sum2_0bar;
  wire [4:0] biased_sum2_1, biased_sum2_1bar;
  wire [4:0] biased_sum3_0, biased_sum3_0bar;
...
module layer3(
    ...
    weighted_inputs_2 w8 (.inputs(inputs0_3), .w(w2_0_3[0]), .wi(weighted_inputs2_0_0));
    weighted_inputs_2 w8_bar (.inputs(inputs0_3), .w(w2_1_3[0]), .wi(weighted_inputs2_0_1));
    weighted_inputs_2 w9 (.inputs(inputs1_3), .w(w2_0_3[1]), .wi(weighted_inputs2_1_0));
    weighted_inputs_2 w9_bar (.inputs(inputs1_3), .w(w2_1_3[1]), .wi(weighted_inputs2_1_1));
    weighted_inputs_2 w10 (.inputs(inputs2_3), .w(w2_0_3[2]), .wi(weighted_inputs2_2_0));
    weighted_inputs_2 w10_bar (.inputs(inputs2_3), .w(w2_1_3[2]), .wi(weighted_inputs2_2_1));
    weighted_inputs_2 w11 (.inputs(inputs3_3), .w(w2_0_3[3]), .wi(weighted_inputs2_3_0));
    weighted_inputs_2 w11_bar (.inputs(inputs3_3), .w(w2_1_3[3]), .wi(weighted_inputs2_3_1));
    weighted_inputs_2 w12 (.inputs(inputs4_3), .w(w2_0_3[4]), .wi(weighted_inputs2_4_0));
    weighted_inputs_2 w12_bar (.inputs(inputs4_3), .w(w2_1_3[4]), .wi(weighted_inputs2_4_1));
    weighted_inputs_2 w13 (.inputs(inputs5_3), .w(w2_0_3[5]), .wi(weighted_inputs2_5_0));
    weighted_inputs_2 w13_bar (.inputs(inputs5_3), .w(w2_1_3[5]), .wi(weighted_inputs2_5_1));
    weighted_inputs_2 w14 (.inputs(inputs6_3), .w(w2_0_3[6]), .wi(weighted_inputs2_6_0));
    weighted_inputs_2 w14_bar (.inputs(inputs6_3), .w(w2_1_3[6]), .wi(weighted_inputs2_6_1));
    weighted_inputs_2 w15 (.inputs(inputs7_3), .w(w2_0_3[7]), .wi(weighted_inputs2_7_0));
    weighted_inputs_2 w15_bar (.inputs(inputs7_3), .w(w2_1_3[7]), .wi(weighted_inputs2_7_1));
    weighted_inputs_2 w16 (.inputs(inputs0_3), .w(w3_0_3[0]), .wi(weighted_inputs3_0_0));
    weighted_inputs_2 w16_bar (.inputs(inputs0_3), .w(w3_1_3[0]), .wi(weighted_inputs3_0_1));
    weighted_inputs_2 w17 (.inputs(inputs1_3), .w(w3_0_3[1]), .wi(weighted_inputs3_1_0));
    weighted_inputs_2 w17_bar (.inputs(inputs1_3), .w(w3_1_3[1]), .wi(weighted_inputs3_1_1));
    weighted_inputs_2 w18 (.inputs(inputs2_3), .w(w3_0_3[2]), .wi(weighted_inputs3_2_0));
    weighted_inputs_2 w18_bar (.inputs(inputs2_3), .w(w3_1_3[2]), .wi(weighted_inputs3_2_1));
    weighted_inputs_2 w19 (.inputs(inputs3_3), .w(w3_0_3[3]), .wi(weighted_inputs3_3_0));
    weighted_inputs_2 w19_bar (.inputs(inputs3_3), .w(w3_1_3[3]), .wi(weighted_inputs3_3_1));
    weighted_inputs_2 w20 (.inputs(inputs4_3), .w(w3_0_3[4]), .wi(weighted_inputs3_4_0));
    weighted_inputs_2 w20_bar (.inputs(inputs4_3), .w(w3_1_3[4]), .wi(weighted_inputs3_4_1));
    weighted_inputs_2 w21 (.inputs(inputs5_3), .w(w3_0_3[5]), .wi(weighted_inputs3_5_0));
    weighted_inputs_2 w21_bar (.inputs(inputs5_3), .w(w3_1_3[5]), .wi(weighted_inputs3_5_1));
    weighted_inputs_2 w22 (.inputs(inputs6_3), .w(w3_0_3[6]), .wi(weighted_inputs3_6_0));
    weighted_inputs_2 w22_bar (.inputs(inputs6_3), .w(w3_1_3[6]), .wi(weighted_inputs3_6_1));
    weighted_inputs_2 w23 (.inputs(inputs7_3), .w(w3_0_3[7]), .wi(weighted_inputs3_7_0));
    weighted_inputs_2 w23_bar (.inputs(inputs7_3), .w(w3_1_3[7]), .wi(weighted_inputs3_7_1));
    weighted_inputs_2 w24 (.inputs(inputs0_3), .w(w4_0_3[0]), .wi(weighted_inputs4_0_0));
    weighted_inputs_2 w24_bar (.inputs(inputs0_3), .w(w4_1_3[0]), .wi(weighted_inputs4_0_1));
    weighted_inputs_2 w25 (.inputs(inputs1_3), .w(w4_0_3[1]), .wi(weighted_inputs4_1_0));
    weighted_inputs_2 w25_bar (.inputs(inputs1_3), .w(w4_1_3[1]), .wi(weighted_inputs4_1_1));
    weighted_inputs_2 w26 (.inputs(inputs2_3), .w(w4_0_3[2]), .wi(weighted_inputs4_2_0));
    weighted_inputs_2 w26_bar (.inputs(inputs2_3), .w(w4_1_3[2]), .wi(weighted_inputs4_2_1));
    weighted_inputs_2 w27 (.inputs(inputs3_3), .w(w4_0_3[3]), .wi(weighted_inputs4_3_0));
    weighted_inputs_2 w27_bar (.inputs(inputs3_3), .w(w4_1_3[3]), .wi(weighted_inputs4_3_1));
    weighted_inputs_2 w28 (.inputs(inputs4_3), .w(w4_0_3[4]), .wi(weighted_inputs4_4_0));
    weighted_inputs_2 w28_bar (.inputs(inputs4_3), .w(w4_1_3[4]), .wi(weighted_inputs4_4_1));
    weighted_inputs_2 w29 (.inputs(inputs5_3), .w(w4_0_3[5]), .wi(weighted_inputs4_5_0));
    weighted_inputs_2 w29_bar (.inputs(inputs5_3), .w(w4_1_3[5]), .wi(weighted_inputs4_5_1));
    weighted_inputs_2 w30 (.inputs(inputs6_3), .w(w4_0_3[6]), .wi(weighted_inputs4_6_0));
    weighted_inputs_2 w30_bar (.inputs(inputs6_3), .w(w4_1_3[6]), .wi(weighted_inputs4_6_1));
    ...
    add4bit_3 u4 (.a(sum2[0]), .b(b1_3), .cin(1'b0), .y(biased_sum2[0]));
    add4bitbar_3 ub0 (.a(sum1bar[0]), .b(b1_3), .cin(1'b0), .y(biased_sum1bar[0]));
    add4bitbar_3 ub4 (.a(sum2bar[0]), .b(b1_3), .cin(1'b0), .y(biased_sum2bar[0]));
    add4bit_3 u1 (.a(sum1[1]), .b(b2_3), .cin(1'b0), .y(biased_sum1[1]));
    add4bit_3 u5 (.a(sum2[1]), .b(b2_3), .cin(1'b0), .y(biased_sum2[1]));
    add4bitbar_3 ub1 (.a(sum1bar[1]), .b(b2_3), .cin(1'b0), .y(biased_sum1bar[1]));
    add4bitbar_3 ub5 (.a(sum2bar[1]), .b(b2_3), .cin(1'b0), .y(biased_sum2bar[1]));
    add4bit_3 u2 (.a(sum1[2]), .b(b3_3), .cin(1'b0), .y(biased_sum1[2]));
    add4bit_3 u6 (.a(sum2[2]), .b(b3_3), .cin(1'b0), .y(biased_sum2[2]));
    add4bitbar_3 ub2 (.a(sum1bar[2]), .b(b3_3), .cin(1'b0), .y(biased_sum1bar[2]));
    add4bitbar_3 ub6 (.a(sum2bar[2]), .b(b3_3), .cin(1'b0), .y(biased_sum2bar[2]));
    add4bit_3 u3 (.a(sum1[3]), .b(b4_3), .cin(1'b0), .y(biased_sum1[3]));
    add4bit_3 u7 (.a(sum2[3]), .b(b4_3), .cin(1'b0), .y(biased_sum2[3]));
    add4bitbar_3 ub3 (.a(sum1bar[3]), .b(b4_3), .cin(1'b0), .y(biased_sum1bar[3]));
    add4bitbar_3 ub7 (.a(sum2bar[3]), .b(b4_3), .cin(1'b0), .y(biased_sum2bar[3]));
    assign biased_sum0_0 = biased_sum1[0];
    assign biased_sum0_1 = biased_sum2[0];
    assign biased_sum0_0bar = biased_sum1bar[0];
    assign biased_sum0_1bar = biased_sum2bar[0];
...
module activation_and_conversion_3(
  ...
  input  wire [3:0] b1_3, b2_3, b3_3, b4_3,
  input  wire r0_0,
  input  wire r1_0,
  input  wire r2_0,
  input  wire r3_0,
...
module layer4(
    ...
    input [3:0] b1_4, b2_4,
    output [4:0] biased_sum0_0, biased_sum0_1, biased_sum0_0bar, biased_sum0_1bar, biased_sum1_0, biased_sum1_1, biased_sum1_0bar, biased_sum1_1bar
);
    wire [0:0] weighted_inputs1_0_0, weighted_inputs1_0_1;
    wire [0:0] weighted_inputs1_1_0, weighted_inputs1_1_1;
    wire [0:0] weighted_inputs1_2_0, weighted_inputs1_2_1;
    ...
    wire [3:0] sum1 [1:0];
    wire [3:0] sum2 [1:0];
    wire [4:0] biased_sum1 [1:0];
    wire [4:0] biased_sum2 [1:0];
    wire [3:0] sum1bar [1:0];
    wire [3:0] sum2bar [1:0];
    wire [4:0] biased_sum1bar [1:0];
    wire [4:0] biased_sum2bar [1:0];
    ...
    weighted_inputs_2 w8 (.inputs(inputs0_4), .w(w2_0_4[0]), .wi(weighted_inputs2_0_0));
    weighted_inputs_2 w8_bar (.inputs(inputs0_4), .w(w2_1_4[0]), .wi(weighted_inputs2_0_1));
    weighted_inputs_2 w9 (.inputs(inputs1_4), .w(w2_0_4[1]), .wi(weighted_inputs2_1_0));
    weighted_inputs_2 w9_bar (.inputs(inputs1_4), .w(w2_1_4[1]), .wi(weighted_inputs2_1_1));
    weighted_inputs_2 w10 (.inputs(inputs2_4), .w(w2_0_4[2]), .wi(weighted_inputs2_2_0));
    weighted_inputs_2 w10_bar (.inputs(inputs2_4), .w(w2_1_4[2]), .wi(weighted_inputs2_2_1));
    weighted_inputs_2 w11 (.inputs(inputs3_4), .w(w2_0_4[3]), .wi(weighted_inputs2_3_0));
    weighted_inputs_2 w11_bar (.inputs(inputs3_4), .w(w2_1_4[3]), .wi(weighted_inputs2_3_1));
    weighted_inputs_2 w12 (.inputs(inputs4_4), .w(w2_0_4[4]), .wi(weighted_inputs2_4_0));
    weighted_inputs_2 w12_bar (.inputs(inputs4_4), .w(w2_1_4[4]), .wi(weighted_inputs2_4_1));
    weighted_inputs_2 w13 (.inputs(inputs5_4), .w(w2_0_4[5]), .wi(weighted_inputs2_5_0));
    weighted_inputs_2 w13_bar (.inputs(inputs5_4), .w(w2_1_4[5]), .wi(weighted_inputs2_5_1));
    weighted_inputs_2 w14 (.inputs(inputs6_4), .w(w2_0_4[6]), .wi(weighted_inputs2_6_0));
    weighted_inputs_2 w14_bar (.inputs(inputs6_4), .w(w2_1_4[6]), .wi(weighted_inputs2_6_1));
    ...
    add4bit_4 u2 (.a(sum2[0]), .b(b1_4), .cin(1'b0), .y(biased_sum2[0]));
    add4bitbar_4 ub0 (.a(sum1bar[0]), .b(b1_4), .cin(1'b0), .y(biased_sum1bar[0]));
    add4bitbar_4 ub2 (.a(sum2bar[0]), .b(b1_4), .cin(1'b0), .y(biased_sum2bar[0]));
    add4bit_4 u1 (.a(sum1[1]), .b(b2_4), .cin(1'b0), .y(biased_sum1[1]));
    add4bit_4 u3 (.a(sum2[1]), .b(b2_4), .cin(1'b0), .y(biased_sum2[1]));
    add4bitbar_4 ub1 (.a(sum1bar[1]), .b(b2_4), .cin(1'b0), .y(biased_sum1bar[1]));
    add4bitbar_4 ub3 (.a(sum2bar[1]), .b(b2_4), .cin(1'b0), .y(biased_sum2bar[1]));
    assign biased_sum0_0 = biased_sum1[0];
    assign biased_sum0_1 = biased_sum2[0];
    assign biased_sum0_0bar = biased_sum1bar[0];
    assign biased_sum0_1bar = biased_sum2bar[0];
...
module output_layer_max (
  ...
  input  wire [0:0] inputs7_4,
    ...
    wire [4:0] biased_sum0_0, biased_sum0_1, biased_sum0_0bar, biased_sum0_1bar;
    ...
    wire [5:0] temp0_0, temp0_1, temp0_0bar, temp0_1bar;
    ...
    comparator_1 c0_bar (
        ...
        .r0_0(r0_0bar), .r1_0(r1_0bar), .r2_0(r2_0bar), .r3_0(r3_0bar), .r4_0(r4_0bar), .r5_0(r5_0bar),
