...
`include "t2.v" // file to be tested
...
module connector_tb;
  ...
  initial begin
    ...
    // weights
    {w1_0_1,w2_0_1,w3_0_1,w4_0_1,w5_0_1,w6_0_1,w7_0_1,w8_0_1} = {8{16'b0000_1111_1111_1111}};
    {w1_0_2,w2_0_2,w3_0_2,w4_0_2,w5_0_2,w6_0_2,w7_0_2,w8_0_2} = {8{16'b0000_1111_1111_1111}};
    {w1_0_3,w2_0_3,w3_0_3,w4_0_3,w5_0_3,w6_0_3,w7_0_3,w8_0_3} = {8{16'b0000_1111_1111_1111}};
    {w1_1_1,w2_1_1,w3_1_1,w4_1_1,w5_1_1,w6_1_1,w7_1_1,w8_1_1} = {8{16'b0000_1111_1111_1111}};
    {w1_1_2,w2_1_2,w3_1_2,w4_1_2,w5_1_2,w6_1_2,w7_1_2,w8_1_2} = {8{16'b0000_1111_1111_1111}};
    {w1_1_3,w2_1_3,w3_1_3,w4_1_3,w5_1_3,w6_1_3,w7_1_3,w8_1_3} = {8{16'b0000_1111_1111_1111}};

    // biases — **drive all of them**
    {b1_1,b2_1,b3_1,b4_1} = {4{12'd0}};
    {b5_1,b6_1,b7_1,b8_1} = {4{12'd0}};

    {b1_2,b2_2,b3_2,b4_2} = {4{5'd1}};
    {b5_2,b6_2,b7_2,b8_2} = {4{5'd1}};  // or 0 — but don’t leave X

    {b1_3,b2_3,b3_3,b4_3} = {4{5'd0}};
    {b5_3,b6_3,b7_3,b8_3} = {4{5'd0}};

    w1_0_4 = 16'b0000_1111_1111_1111; w1_1_4 = 16'b0000_1111_1111_1111;
    w2_0_4 = 16'b0000_1111_1111_1111; w2_1_4 = 16'b0000_1111_1111_1111;
    w3_0_4 = 16'b0000_1111_1111_1111; w3_1_4 = 16'b0000_1111_1111_1111;
    w4_0_4 = 16'b0000_1111_1111_1111; w4_1_4 = 16'b0000_1111_1111_1111;

    b1_4 = 5'd0; b2_4 = 5'd2; b3_4 = 5'd0; b4_4 = 5'd0;
